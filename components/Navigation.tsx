      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://github.com/whiteboardmonk/agcluster-container" target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-gray-800 text-white rounded-lg hover:border-gray-700 transition-all">
              GitHub
            </a>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden border-t border-gray-800 py-4 space-y-4">
            ...
            <a href="https://github.com/whiteboardmonk/agcluster-container" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 border border-gray-800 text-white rounded-lg">
              GitHub
            </a>
          </div>
        )}
