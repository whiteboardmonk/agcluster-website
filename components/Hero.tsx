...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary-950 via-purple-950 to-black opacity-50" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        {/* Badge */}
        <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 mb-8 animate-fade-in">
          <span className="w-2 h-2 bg-primary-400 rounded-full animate-pulse" />
          <span className="text-sm text-primary-300">v0.2 • Active Development</span>
        </div>

        {/* Main headline */}
        <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-slide-up">
          <span className="block mb-2">Claude Agent Code</span>
          <span className="gradient-text">Container Platform</span>
        </h1>

        {/* Subheadline */}
        <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
          Self-hosted developer platform for Claude Agent SDK with integrated Web UI, real-time monitoring, and task tracking.
          Deploy agents with full visibility and control.
        </p>
        ...
        <div className="max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.3s' }}>
          <div className="glass-effect rounded-lg p-6 text-left overflow-x-auto">
